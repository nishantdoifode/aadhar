...
const Aboutpage = () => {
    return (
        <>
        <div className="aboutnavimg">
            <img src="/imgs/AboutUIDAI_Web.png" alt="" />
        </div>
                ...
                <section id="twdiv">
                    ...
                    <div>
                        <ul id="aadhaar-links">
                            ...
                            <li><a href="#">Updated Regulations</a></li>
                            <li><a href="#">Updated Rules</a></li>
                        </ul>
                    </div>
                </section>
              </div>
                ...
                <section id="twdiv">
                    ...
                    <div>
                        <ul id="aadhaar-links">
                            ...
                            <li><a href="#">Volunteers/Sabbatical</a></li>
                            <li><a href="#">Officers Served in the Past</a></li>
                            <li><a href="#">Tenders</a></li>
                            <li><a href="#">Internship in UIDAI</a></li>
                            <li><a href="#">Young Professional Hiring Policy</a></li>
                            <li><a href="#">Advertisement for Hiring of Technical Consultants</a></li>
                        </ul>
                    </div>
                </section>
              </div>
      ...
      <div className="rightsectionabout">
            ...
            <div className="QNA">
                ...
                <div>Aadhaar (Targeted Delivery of Financial and Other Subsidies Benefits and Services) Act,2016</div>
                <div>Notification regarding establishment of UIDAI as Authority - 12 july 2016</div>
                <div>Notification of regarding enforing relavant sections of the aadhaar Act 2016 - 12 july 2016</div>
                <div>Notification of regarding Terms and Condition of service of chairperson and members - 12 july 2016</div>
